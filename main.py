...
def evaluate_board(game):
    """
    A simple evaluation function that calculates a weighted score based on material.

    This version converts the board to a string (using Chessnut's string representation)
    and then iterates over its characters.
    """
    material_values = {
...
def minimax(game, depth, is_maximizing, alpha, beta, start_time, time_limit):
    ...
    In this implementation, a game with game.status != 0 is considered terminal.
    """
